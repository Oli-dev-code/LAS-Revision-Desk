...
window.diagramQuestionDatabase = [
  ...
  { id: 'diagram-lymphatic-urinary-reproductive-01', topic: 'lymphatic-urinary-reproductive', type: 'diagram', question: 'Drag each label onto the matching structure in the combined systems diagram.', explanation: 'The kidneys filter blood and form urine, the bladder stores urine, and lymphatic vessels return excess tissue fluid to the circulation.', diagram: { image: 'assets/test-diagrams/lymphatic-urinary-reproductive-test.svg', alt: 'Lymphatic, urinary and reproductive systems diagram for the test', labels: [{ id: 'lymph-vessels', name: 'Lymphatic vessels', x: 13, y: 19, targetWidth: 190 }, { id: 'kidneys', name: 'Kidneys', x: 79, y: 40 }, { id: 'bladder', name: 'Bladder', x: 77, y: 65 }, { id: 'reproductive-organs', name: 'Reproductive organs', x: 79, y: 90 }] } }
];
