...
window.diagramQuestionDatabase = [
  ...
  { id: 'diagram-nervous-01', topic: 'nervous', type: 'diagram', question: 'Drag the central and peripheral nervous system labels onto the diagram.', explanation: 'The central nervous system is the brain and spinal cord. The peripheral nervous system is the network of nerves outside them.', diagram: { image: 'assets/test-diagrams/nervous-system-test.png', alt: 'Central and peripheral nervous system diagram for the test', labels: [{ id: 'central', name: 'Central nervous system', x: 80, y: 9 }, { id: 'peripheral', name: 'Peripheral nervous system', x: 81, y: 68 }] } },
