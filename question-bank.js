...
window.diagramQuestionDatabase = [
  { id: 'diagram-body-01', topic: 'body', type: 'diagram', question: 'Drag each level of organisation onto the matching part of the diagram.', explanation: 'The sequence is atom, molecule, cell, tissue, organ, organ system and organism.', diagram: { image: 'assets/test-diagrams/body-organisation-test.jpeg', alt: 'Body organisation diagram for the test', labels: [{ id: 'atom', name: 'Atom', x: 13, y: 37 }, { id: 'molecule', name: 'Molecule', x: 39, y: 37 }, { id: 'cell', name: 'Cell', x: 64, y: 37 }, { id: 'tissue', name: 'Tissue', x: 13, y: 77 }, { id: 'organ', name: 'Organ', x: 39, y: 77 }, { id: 'organ-system', name: 'Organ system', x: 64, y: 77 }, { id: 'organism', name: 'Organism', x: 88, y: 77 }] } },
  { id: 'diagram-cardiovascular-01', topic: 'cardiovascular', type: 'diagram', question: 'Drag each label onto the matching structure in the heart diagram.', explanation: 'The right side of the cutaway heart receives and pumps deoxygenated blood, while the left side receives and pumps oxygenated blood. The aorta leaves the left ventricle and the pulmonary trunk leaves the right ventricle.', diagram: { image: 'assets/test-diagrams/heart-anatomy-test.jpeg', alt: 'Heart anatomy diagram for the test', labels: [{ id: 'aorta', name: 'Aorta', x: 76, y: 30 }, { id: 'superior-vena-cava', name: 'Superior vena cava', x: 63, y: 40 }, { id: 'right-atrium', name: 'Right atrium', x: 63, y: 54 }, { id: 'pulmonary-valve', name: 'Pulmonary valve', x: 57, y: 61 }, { id: 'right-ventricle', name: 'Right ventricle', x: 65, y: 78 }, { id: 'left-atrium', name: 'Left atrium', x: 82, y: 54 }, { id: 'mitral-valve', name: 'Mitral valve', x: 80, y: 62 }, { id: 'left-ventricle', name: 'Left ventricle', x: 80, y: 80 }] } },
  { id: 'diagram-respiratory-01', topic: 'respiratory', type: 'diagram', question: 'Drag each airway label onto the matching structure.', explanation: 'Air passes through the nasopharynx and mouth, down the trachea, through the bronchial tree and into the lungs. The diaphragm supports ventilation.', diagram: { image: 'assets/test-diagrams/respiratory-system-test.png', alt: 'Respiratory system diagram for the test', labels: [{ id: 'nasopharynx', name: 'Nasopharynx', x: 36, y: 14 }, { id: 'mouth', name: 'Mouth', x: 76, y: 22 }, { id: 'trachea', name: 'Trachea', x: 49, y: 35 }, { id: 'lungs', name: 'Lungs', x: 37, y: 49 }, { id: 'bronchial-tree', name: 'Bronchial tree', x: 35, y: 60 }, { id: 'diaphragm', name: 'Diaphragm', x: 67, y: 78 }] } },
  { id: 'diagram-nervous-01', topic: 'nervous', type: 'diagram', question: 'Drag the central and peripheral nervous system labels onto the diagram.', explanation: 'The central nervous system is the brain and spinal cord. The peripheral nervous system is the network of nerves outside them.', diagram: { image: 'assets/test-diagrams/nervous-system-test.png', alt: 'Central and peripheral nervous system diagram for the test', labels: [{ id: 'central', name: 'Central nervous system', x: 38, y: 21 }, { id: 'peripheral', name: 'Peripheral nervous system', x: 68, y: 55 }] } },
  { id: 'diagram-lymphatic-urinary-reproductive-01', topic: 'lymphatic-urinary-reproductive', type: 'diagram', question: 'Drag each label onto the matching structure in the combined systems diagram.', explanation: 'The kidneys filter blood and form urine, the bladder stores urine, and lymphatic vessels return excess tissue fluid to the circulation.', diagram: { image: 'assets/test-diagrams/lymphatic-urinary-reproductive-test.svg', alt: 'Lymphatic, urinary and reproductive systems diagram for the test', labels: [{ id: 'lymph-vessels', name: 'Lymphatic vessels', x: 23, y: 34 }, { id: 'kidneys', name: 'Kidneys', x: 50, y: 34 }, { id: 'bladder', name: 'Bladder', x: 50, y: 59 }, { id: 'reproductive-organs', name: 'Reproductive organs', x: 50, y: 77 }] } }
];
